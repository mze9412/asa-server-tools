...
[source,sh]
curl -sL https:/ttps://github.com/mze9412/asa-server-tools/raw/branch/master/netinstall.sh | sudo bash -s steam --install-proton-ge
...
[source,sh]
curl -sL https:/ttps://github.com/mze9412/asa-server-tools/raw/branch/master/netinstall.sh | bash -s -- --me --install-proton-ge
