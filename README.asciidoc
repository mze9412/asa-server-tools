...
NB: Change the ports according to the ones set in your `asamanager.cfg` file. GamePort is UDP, RCON port is using TCP.
...
curl -sL https://https://raw.githubusercontent.com/mze9412/asa-server-tools/refs/heads/master/netinstall.sh | sudo bash -s steam --install-proton-ge
...
[source,sh]
curl -sL https://https://raw.githubusercontent.com/mze9412/asa-server-tools/refs/heads/master/netinstall.sh | bash -s -- --me --install-proton-ge
