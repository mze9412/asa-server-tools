...
[source,sh]
curl -sL https://git.mze9412.info/ARKSurvivalAscended/asa-server-tools/raw/branch/master/netinstall.sh | | sudo bash -s steam --install-proton-ge
...
[source,sh]
curl -sL https://git.mze9412.info/ARKSurvivalAscended/asa-server-tools/raw/branch/master/netinstall.sh | bash -s -- --me --install-proton-ge
